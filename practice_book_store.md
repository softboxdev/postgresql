...
## Часть 10. Создаём таблицу и делаем первый SELECT

Теперь вы можете работать. Введите:
...
INSERT INTO test (name) VALUES ('Моя первая запись');
...
- Создали базу данных
- Создали своего пользователя
- Создали таблицу
- Вставили и прочитали данные

---

## Часть 11. Как выйти и зайти обратно
...
## Часть 12. Полезные команды, которые нужно запомнить
...
## Часть 13. Установка графического интерфейса (pgAdmin) — по желанию
...
## Часть 14. Что делать, если что-то пошло не так
...
## Часть 15. Чек-лист: что должно быть готово
