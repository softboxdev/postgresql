...
## Часть 07. Как выйти и зайти обратно
...
## Часть 08. Полезные команды, которые нужно запомнить
...
## Часть 09. Установка графического интерфейса (pgAdmin) — по желанию
...
## Часть 10. Что делать, если что-то пошло не так
...
## Часть 11. Чек-лист: что должно быть готово
